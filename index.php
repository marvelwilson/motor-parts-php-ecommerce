<?php 
 ...
 ?>
                ...
                <div class="container">
                    <div class="block-slideshow__carousel">
                        <div class="owl-carousel">
                            <?php 
                                $select_banner = mysqli_query(connection(),"SELECT * FROM banner ");
                             if (mysqli_num_rows($select_banner)>0) {
                                 while ($result_banner = mysqli_fetch_assoc($select_banner)) {
                             ?>
                            <a class="block-slideshow__item" href="category-4-columns-sidebar?pro-q=<?php echo $result_banner['banner_cat'] ?>">
                                <span class="block-slideshow__item-image " style="background-image: url('admin/img/banners/<?php echo $result_banner['banner_image'] ?>')"></span>
                                <span class="block-slideshow__item-title">
                                   <?php echo $result_banner['banner_title'] ?>
                                </span>
                                <span class="block-slideshow__item-details">
                                   <?php echo $result_banner['banner_discription']; ?>
                                </span>
                        ...
                        <div class="block-zone__card category-card category-card--layout--overlay">
                            <div class="category-card__body">
                                <div class="category-card__overlay-image">
                                    <img  src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT5DgLY5EtGwq4Olwr065kE1jfeZzH_s-F8lw&usqp=CAU" sizes="(max-width: 575px) 530px, 305px" alt="">
                                </div>
                                <div class="category-card__content">
                                    <div class="category-card__info">
                                        <div class="category-card__name">
                                            <a href="category-4-columns-sidebar?pro-q=Wheels & Tires">Wheels & Tires</a>
                                        </div>
                                        <ul class="category-card__children">
                                            <li><a href="index?q=Wheels & Tires>Wheel Covers">Wheel Covers</a></li>
                                            <li><a href="index?q=Wheels & Tires>Brake Kits">Brake Kits</a></li>
                                            <li><a href="index?q=Wheels & Tires>Tire Chains">Tire Chains</a></li>
                                            <li><a href="index?q=Wheels & Tires>Wheel disks">Wheel disks</a></li>
                                            <li><a href="index?q=Wheels & Tires>Tires">Tires</a></li>
                                            <li><a href="index?q=Wheels & Tires>Sensors">Sensors</a></li>
                                            <li><a href="index?q=Wheels & Tires>Accessories">Accessories</a></li>

                                        </ul>
                                        <div class="category-card__actions">
                                            <a href="category-4-columns-sidebar?pro-q=Wheels & Tires" class="btn btn-primary btn-sm">Shop All</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="block-zone__widget">
                            <div class="block-zone__widget-header">
                                <div class="block-zone__tabs">
                                    <button class="block-zone__tabs-button  block-zone__tabs-button--active"  onclick="function num1() {
                                        ipb = document.getElementById('ip_bestsellers');
                                        ipp = document.getElementById('id_popular');

                                      ipb.style.display='block'
                                      ipp.style.display='none'

                                    }num1()"type="button">Bestsellers</button>
                                    <button class="block-zone__tabs-button" onclick="function num1() {
                                        ipb = document.getElementById('ip_bestsellers');
                                        ipp = document.getElementById('id_popular');

                                      ipb.style.display='none'
                                      ipp.style.display='block'

                                    }num1()" type="button">Popular</button>
                                </div>
                            ...
                            <div class="block-zone__widget-body">
                                <div class="block-zone__carousel">
                                    <div class="block-zone__carousel-loader"></div>
                                     <div class="owl-carousel" id="ip_bestsellers">
                                         <?php 
                                        $cat = 'Wheels & Tires';
                                        $sele  = mysqli_query(connection(),"SELECT * FROM product_details WHERE item_option='bestseller'");
                                                ...
                                                <div class="product-card__image">
                                                    ...
                                                    <div class="status-badge status-badge--style--success product-card__fit status-badge--has-icon status-badge--has-text">
                                                        <div class="status-badge__body">
                                                            ...
                                                            <div class="status-badge__text"><?php echo $result['title']; ?></div>
                                                            <div class="status-badge__tooltip" tabindex="0" data-toggle="tooltip" title="<?php echo $result['title']; ?>"></div>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z" />
                                    ...
                                    <div class="owl-carousel" id="id_popular" style="display: none;">
                                       
                                                                                    <?php 
                                        $cat = 'Engine & Drivetrain';
                                        $sele  = mysqli_query(connection(),"SELECT * FROM product_details WHERE item_option='popular'");
                           if (mysqli_num_rows($sele)>0) {
                               while ($result = mysqli_fetch_assoc($sele)) {
                                $i = explode('>', $result['category']);
                                if ($i[0]==$cat) {
                ...
                <div class="container">
                    <div class="block-zone__body">
                        <div class="block-zone__card category-card category-card--layout--overlay">
                            <div class="category-card__body">
                                <div class="category-card__overlay-image">
                                    <img  src="https://assets.flatpyramid.com/wp-content/uploads/2019/01/10043621/diesel-turbo-6-cylinder-engine-3d-model-299636.jpg" sizes="(max-width: 575px) 530px, 305px" alt="">
                                </div>
                                <div class="category-card__content">
                                    <div class="category-card__info">
                                        <div class="category-card__name">
                                            <a href="category-4-columns-sidebar?pro-q=Interior Parts">Interior Parts</a>
                                        </div>
                                        <ul class="category-card__children">
                                            <li><a href="index?q=Interior Parts>Dashboards">Dashboards</a></li>
                                            <li><a href="index?q=Interior Parts>Seat Covers">Seat Covers</a></li>
                                            <li><a href="index?q=Interior Parts>Floor Mats">Floor Mats</a></li>
                                            <li><a href="index?q=Interior Parts>Sun Shades">Sun Shades</a></li>
                                            <li><a href="index?q=Interior Parts>Visors">Visors</a></li>
                                            <li><a href="index?q=Interior Parts>Car Covers">Car Covers</a></li>
                                            <li><a href="index?q=Interior Parts>Accessories">Accessories</a></li>
                                        </ul>
                                        <div class="category-card__actions">
                                            <a href="category-4-columns-sidebar?pro-q=Interior Partr" class="btn btn-primary btn-sm">Shop All</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="block-zone__widget">
                            <div class="block-zone__widget-header">
                                <div class="block-zone__tabs">
                                    <button class="block-zone__tabs-button block-zone__tabs-button--active" onclick="function num1() {
                                        ipb = document.getElementById('ip_bestsellers1');
                                        ipp = document.getElementById('id_popular1');

                                      ipb.style.display='block'
                                      ipp.style.display='none'

                                    }num1()" type="button">Bestsellers</button>
                                    <button class="block-zone__tabs-button" type="button" onclick="function num1() {
                                        ipb = document.getElementById('ip_bestsellers1');
                                        ipp = document.getElementById('id_popular1');
    ...
    C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                            ...
                            <div class="block-zone__widget-body">
                                <div class="block-zone__carousel">
                                    <div class="block-zone__carousel-loader"></div>
                                    <div class="owl-carousel" id="ip_bestsellers1">
                                         <?php 
                                        $cat = 'Interior Parts';
                                        $sele  = mysqli_query(connection(),"SELECT * FROM product_details WHERE item_option='bestseller'");
                           if (mysqli_num_rows($sele)>0) {
    ...
    C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z" />
                                    ...
                                    <div class="owl-carousel" id="id_popular1" style="display: none;">
                ...
                <div class="container">
                    <div class="block-zone__body">
                        <div class="block-zone__card category-card category-card--layout--overlay">
                            <div class="category-card__body">
                                <div class="category-card__overlay-image">
                                    <img  src="https://i2.wp.com/www.theengineblock.com/wp-content/uploads/2017/05/potucek-engine-bay.jpg?fit=800%2C445&ssl=1&resize=350%2C200" sizes="(max-width: 575px) 530px, 305px" alt="">
                                </div>
                                <div class="category-card__content">
                                    <div class="category-card__info">
                                        <div class="category-card__name">
                                            <a href="category-4-columns-sidebar?pro-q=Engine & Drivetrain">Engine & Drivetrain</a>
                                        </div>
                                        <ul class="category-card__children">
                                            <li><a href="index?q=Engine & Drivetrain>Timing Belts">Timing Belts</a></li>
                                            <li><a href="index?q=Engine & Drivetrain>Spark Plugs">Spark Plugs</a></li>
                                            <li><a href="index?q=Engine & Drivetrain>Oil Pans">Oil Pans</a></li>
                                            <li><a href="index?q=Engine & Drivetrain>Engine  Gaskets">Engine Gaskets</a></li>
                                            <li><a href="index?q=Engine & Drivetrain>Oil Filters">Oil Filters</a></li>
                                            <li><a href="index?q=Engine & Drivetrain>Engine Mounts">Engine Mounts</a></li>
                                            <li><a href="index?q=Engine & Drivetrain>Accessories">Accessories</a></li>
                                        </ul>
                                        <div class="category-card__actions">
                                            <a href="category-4-columns-sidebar?pro-q=Engine & Drivetrain" class="btn btn-primary btn-sm">Shop All</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="block-zone__widget">
                            <div class="block-zone__widget-header">
                                <div class="block-zone__tabs">
                                    <button class="block-zone__tabs-button block-zone__tabs-button--active" onclick="function num1() {
                                        ipb = document.getElementById('ip_bestsellers2');
                                        ipp = document.getElementById('id_popular2');
    ...
    C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                            ...
                            <div class="block-zone__widget-body">
                                <div class="block-zone__carousel">
                                    <div class="block-zone__carousel-loader"></div>
                                             <div class="owl-carousel" id="ip_bestsellers2">
                                         <?php 
                                        $cat = 'Engine & Drivetrain';
                                        $sele  = mysqli_query(connection(),"SELECT * FROM product_details WHERE item_option='bestseller'");
                           if (mysqli_num_rows($sele)>0) {
    ...
    C17.9,5.2,17.7,5,17.5,5H9.4C9.2,5,9,4.8,9,4.6V3.4C9,3.2,9.2,3,9.4,3h9.2C19.4,3,20,3.6,20,4.4z" />
                                    ...
                                    <div class="owl-carousel" id="id_popular2" style="display: none;">
                ...
                <div class="container">
                    <div class="block-banners__list">
                        <a href="" class="block-banners__item block-banners__item--style--one">
                            <span class="block-banners__item-image"><img src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/man-pouring-oil-into-car-royalty-free-image-1598901693.jpg" alt=""></span>
                            <span class="block-banners__item-image block-banners__item-image--blur"><img src="https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/man-pouring-oil-into-car-royalty-free-image-1598901693.jpg" alt=""></span>
	...
	C-0.1,9.8-0.1,10.4,0.3,10.7z" />
                    ...
                    <div class="block-products-carousel__carousel">
                        ...
                        <div class="owl-carousel">
                              <?php 
                                $sele  = mysqli_query(connection(),"SELECT * FROM product_details ORDER BY id DESC LIMIT 10");
                           if (mysqli_num_rows($sele)>0) {
                               while ($result = mysqli_fetch_assoc($sele)) {
                                $image = json_decode($result['ad_images']);
                               ?>
                    ...
                    <div class="row">
                        <div class="col-4">
                            ...
                            <div class="block-products-columns__list">
                                <?php 
                                $sele  = mysqli_query(connection(),"SELECT * FROM product_details ORDER BY id DESC LIMIT 4");
                           if (mysqli_num_rows($sele)>0) {
                               while ($result = mysqli_fetch_assoc($sele)) {
                                $image = json_decode($result['ad_images']);
                               ?>
                            ...
                            <div class="block-products-columns__list">
                             <?php 
                                $sele  = mysqli_query(connection(),"SELECT * FROM product_details WHERE item_option='bestseller' ORDER BY id DESC LIMIT 4");
                           if (mysqli_num_rows($sele)>0) {
                               while ($result = mysqli_fetch_assoc($sele)) {
                                $image = json_decode($result['ad_images']);
                               ?>
